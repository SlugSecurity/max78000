...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn rx_ov_ch0(&mut self) -> RX_OV_CH0_W<INTEN_SPEC, 0> {
        RX_OV_CH0_W::new(self)
    }
    #[doc = "Bit 1 - Enable for interrupt when RX FIFO reaches the number of bytes configured by the RXTHD field."]
    #[inline(always)]
    #[must_use]
    pub fn rx_thd_ch0(&mut self) -> RX_THD_CH0_W<INTEN_SPEC, 1> {
        RX_THD_CH0_W::new(self)
    }
    #[doc = "Bit 2 - Enable for interrupt when TX FIFO has only one byte remaining."]
    #[inline(always)]
    #[must_use]
    pub fn tx_ob_ch0(&mut self) -> TX_OB_CH0_W<INTEN_SPEC, 2> {
        TX_OB_CH0_W::new(self)
    }
    #[doc = "Bit 3 - Enable for interrupt when TX FIFO is half empty."]
    #[inline(always)]
    #[must_use]
    pub fn tx_he_ch0(&mut self) -> TX_HE_CH0_W<INTEN_SPEC, 3> {
