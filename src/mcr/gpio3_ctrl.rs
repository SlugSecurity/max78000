...
pub type P30_DO_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type P30_OE_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type P30_PE_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type P30_IN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type P31_DO_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type P31_OE_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type P31_PE_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type P31_IN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn p30_do(&mut self) -> P30_DO_W<GPIO3_CTRL_SPEC, 0> {
        P30_DO_W::new(self)
    }
    #[doc = "Bit 1 - GPIO3 Pin 0 Output Enable."]
    #[inline(always)]
    #[must_use]
    pub fn p30_oe(&mut self) -> P30_OE_W<GPIO3_CTRL_SPEC, 1> {
        P30_OE_W::new(self)
    }
    #[doc = "Bit 2 - GPIO3 Pin 0 Pull-up Enable."]
    #[inline(always)]
    #[must_use]
    pub fn p30_pe(&mut self) -> P30_PE_W<GPIO3_CTRL_SPEC, 2> {
        P30_PE_W::new(self)
    }
    #[doc = "Bit 3 - GPIO3 Pin 0 Input Status."]
    #[inline(always)]
    #[must_use]
    pub fn p30_in(&mut self) -> P30_IN_W<GPIO3_CTRL_SPEC, 3> {
        P30_IN_W::new(self)
    }
    #[doc = "Bit 4 - GPIO3 Pin 1 Data Output."]
    #[inline(always)]
    #[must_use]
    pub fn p31_do(&mut self) -> P31_DO_W<GPIO3_CTRL_SPEC, 4> {
        P31_DO_W::new(self)
    }
    #[doc = "Bit 5 - GPIO3 Pin 1 Output Enable."]
    #[inline(always)]
    #[must_use]
    pub fn p31_oe(&mut self) -> P31_OE_W<GPIO3_CTRL_SPEC, 5> {
        P31_OE_W::new(self)
    }
    #[doc = "Bit 6 - GPIO3 Pin 1 Pull-up Enable."]
    #[inline(always)]
    #[must_use]
    pub fn p31_pe(&mut self) -> P31_PE_W<GPIO3_CTRL_SPEC, 6> {
        P31_PE_W::new(self)
    }
    #[doc = "Bit 7 - GPIO3 Pin 1 Input Status."]
    #[inline(always)]
    #[must_use]
    pub fn p31_in(&mut self) -> P31_IN_W<GPIO3_CTRL_SPEC, 7> {
        P31_IN_W::new(self)
    }
