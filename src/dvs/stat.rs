...
pub type DVS_STATE_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 4, O>;
...
pub type ADJ_UP_ENA_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type ADJ_DWN_ENA_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type ADJ_ACTIVE_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type CTR_TAP_OK_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type CTR_TAP_SEL_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type SLOW_TRIP_DET_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type FAST_TRIP_DET_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type PS_IN_RANGE_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type PS_VCNTR_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 7, O>;
...
pub type MON_DLY_OK_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type ADJ_DLY_OK_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type LO_LIMIT_DET_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type HI_LIMIT_DET_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type VALID_TAP_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type LIMIT_ERR_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type RANGE_ERR_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type ADJ_ERR_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type REF_SEL_ERR_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type FB_TO_ERR_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type FB_TO_ERR_S_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type FC_LV_DET_INT_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type FC_LV_DET_S_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dvs_state(&mut self) -> DVS_STATE_W<STAT_SPEC, 0> {
        DVS_STATE_W::new(self)
    }
    #[doc = "Bit 4 - DVS Raising voltage"]
    #[inline(always)]
    #[must_use]
    pub fn adj_up_ena(&mut self) -> ADJ_UP_ENA_W<STAT_SPEC, 4> {
        ADJ_UP_ENA_W::new(self)
    }
    #[doc = "Bit 5 - DVS Lowering voltage"]
    #[inline(always)]
    #[must_use]
    pub fn adj_dwn_ena(&mut self) -> ADJ_DWN_ENA_W<STAT_SPEC, 5> {
        ADJ_DWN_ENA_W::new(self)
    }
    #[doc = "Bit 6 - Adjustment to a Direct Voltage"]
    #[inline(always)]
    #[must_use]
    pub fn adj_active(&mut self) -> ADJ_ACTIVE_W<STAT_SPEC, 6> {
        ADJ_ACTIVE_W::new(self)
    }
    #[doc = "Bit 7 - Tap Enabled and the Tap is withing Hi/Low limits"]
    #[inline(always)]
    #[must_use]
    pub fn ctr_tap_ok(&mut self) -> CTR_TAP_OK_W<STAT_SPEC, 7> {
        CTR_TAP_OK_W::new(self)
    }
    #[doc = "Bit 8 - Status of selected center tap delay line detect output"]
    #[inline(always)]
    #[must_use]
    pub fn ctr_tap_sel(&mut self) -> CTR_TAP_SEL_W<STAT_SPEC, 8> {
        CTR_TAP_SEL_W::new(self)
    }
    #[doc = "Bit 9 - Provides the current combined status of all selected Low Range delay lines"]
    #[inline(always)]
    #[must_use]
    pub fn slow_trip_det(&mut self) -> SLOW_TRIP_DET_W<STAT_SPEC, 9> {
        SLOW_TRIP_DET_W::new(self)
    }
    #[doc = "Bit 10 - Provides the current combined status of all selected High Range delay lines"]
    #[inline(always)]
    #[must_use]
    pub fn fast_trip_det(&mut self) -> FAST_TRIP_DET_W<STAT_SPEC, 10> {
        FAST_TRIP_DET_W::new(self)
    }
    #[doc = "Bit 11 - Indicates if the power supply is in range"]
    #[inline(always)]
    #[must_use]
    pub fn ps_in_range(&mut self) -> PS_IN_RANGE_W<STAT_SPEC, 11> {
        PS_IN_RANGE_W::new(self)
    }
    #[doc = "Bits 12:18 - Voltage Count value sent to the power supply"]
    #[inline(always)]
    #[must_use]
    pub fn ps_vcntr(&mut self) -> PS_VCNTR_W<STAT_SPEC, 12> {
        PS_VCNTR_W::new(self)
    }
    #[doc = "Bit 19 - Indicates the monitor delay count is at 0"]
    #[inline(always)]
    #[must_use]
    pub fn mon_dly_ok(&mut self) -> MON_DLY_OK_W<STAT_SPEC, 19> {
        MON_DLY_OK_W::new(self)
    }
    #[doc = "Bit 20 - Indicates the adjustment delay count is at 0"]
    #[inline(always)]
    #[must_use]
    pub fn adj_dly_ok(&mut self) -> ADJ_DLY_OK_W<STAT_SPEC, 20> {
        ADJ_DLY_OK_W::new(self)
    }
    #[doc = "Bit 21 - Power supply voltage counter is at low limit"]
    #[inline(always)]
    #[must_use]
    pub fn lo_limit_det(&mut self) -> LO_LIMIT_DET_W<STAT_SPEC, 21> {
        LO_LIMIT_DET_W::new(self)
    }
    #[doc = "Bit 22 - Power supply voltage counter is at high limit"]
    #[inline(always)]
    #[must_use]
    pub fn hi_limit_det(&mut self) -> HI_LIMIT_DET_W<STAT_SPEC, 22> {
        HI_LIMIT_DET_W::new(self)
    }
    #[doc = "Bit 23 - At least one delay line has been enabled"]
    #[inline(always)]
    #[must_use]
    pub fn valid_tap(&mut self) -> VALID_TAP_W<STAT_SPEC, 23> {
        VALID_TAP_W::new(self)
    }
    #[doc = "Bit 24 - Interrupt flag that indicates a voltage count is at/beyond manufacturer limits"]
    #[inline(always)]
    #[must_use]
    pub fn limit_err(&mut self) -> LIMIT_ERR_W<STAT_SPEC, 24> {
        LIMIT_ERR_W::new(self)
    }
    #[doc = "Bit 25 - Interrupt flag that indicates a tap has an invalid value"]
    #[inline(always)]
    #[must_use]
    pub fn range_err(&mut self) -> RANGE_ERR_W<STAT_SPEC, 25> {
        RANGE_ERR_W::new(self)
    }
    #[doc = "Bit 26 - Interrupt flag that indicates up and down adjustment requested simultaneously"]
    #[inline(always)]
    #[must_use]
    pub fn adj_err(&mut self) -> ADJ_ERR_W<STAT_SPEC, 26> {
        ADJ_ERR_W::new(self)
    }
    #[doc = "Bit 27 - Indicates the ref select register bit is out of range"]
    #[inline(always)]
    #[must_use]
    pub fn ref_sel_err(&mut self) -> REF_SEL_ERR_W<STAT_SPEC, 27> {
        REF_SEL_ERR_W::new(self)
    }
    #[doc = "Bit 28 - Interrupt flag that indicates a timeout while adjusting the voltage"]
    #[inline(always)]
    #[must_use]
    pub fn fb_to_err(&mut self) -> FB_TO_ERR_W<STAT_SPEC, 28> {
        FB_TO_ERR_W::new(self)
    }
    #[doc = "Bit 29 - Interrupt flag that mirror FB_TO_ERR and is write one clear"]
    #[inline(always)]
    #[must_use]
    pub fn fb_to_err_s(&mut self) -> FB_TO_ERR_S_W<STAT_SPEC, 29> {
        FB_TO_ERR_S_W::new(self)
    }
    #[doc = "Bit 30 - Interrupt flag that indicates the power supply voltage requested is below the low threshold"]
    #[inline(always)]
    #[must_use]
    pub fn fc_lv_det_int(&mut self) -> FC_LV_DET_INT_W<STAT_SPEC, 30> {
        FC_LV_DET_INT_W::new(self)
    }
    #[doc = "Bit 31 - Interrupt flag that mirrors FC_LV_DET_INT"]
    #[inline(always)]
    #[must_use]
    pub fn fc_lv_det_s(&mut self) -> FC_LV_DET_S_W<STAT_SPEC, 31> {
