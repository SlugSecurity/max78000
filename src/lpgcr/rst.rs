...
pub type GPIO2_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O, RESET_A>;
...
pub type WDT1_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O, RESET_A>;
...
pub type TMR4_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O, RESET_A>;
...
pub type TMR5_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O, RESET_A>;
...
pub type UART3_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O, RESET_A>;
...
pub type LPCOMP_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O, RESET_A>;
