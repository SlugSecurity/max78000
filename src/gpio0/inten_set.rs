...
pub type GPIO_INTEN_SET_W<'a, REG, const O: u8> =
    crate::FieldWriter<'a, REG, 32, O, GPIO_INTEN_SET_A>;
impl<'a, REG, const O: u8> GPIO_INTEN_SET_W<'a, REG, O>
where
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn gpio_inten_set(&mut self) -> GPIO_INTEN_SET_W<INTEN_SET_SPEC, 0> {
