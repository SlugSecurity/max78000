...
pub type GPIO_INTEN_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 32, O, GPIO_INTEN_A>;
impl<'a, REG, const O: u8> GPIO_INTEN_W<'a, REG, O>
where
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn gpio_inten(&mut self) -> GPIO_INTEN_W<INTEN_SPEC, 0> {
