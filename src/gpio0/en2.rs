...
pub type GPIO_EN2_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 32, O, GPIO_EN2_A>;
impl<'a, REG, const O: u8> GPIO_EN2_W<'a, REG, O>
where
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn gpio_en2(&mut self) -> GPIO_EN2_W<EN2_SPEC, 0> {
        GPIO_EN2_W::new(self)
    }
