...
pub type GPIO_INTPOL_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 32, O, GPIO_INTPOL_A>;
impl<'a, REG, const O: u8> GPIO_INTPOL_W<'a, REG, O>
where
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn gpio_intpol(&mut self) -> GPIO_INTPOL_W<INTPOL_SPEC, 0> {
