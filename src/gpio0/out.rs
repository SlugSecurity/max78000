...
pub type GPIO_OUT_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 32, O, GPIO_OUT_A>;
impl<'a, REG, const O: u8> GPIO_OUT_W<'a, REG, O>
where
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn gpio_out(&mut self) -> GPIO_OUT_W<OUT_SPEC, 0> {
        GPIO_OUT_W::new(self)
    }
