...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn done(&mut self) -> DONE_W<INTFL_SPEC, 0> {
        DONE_W::new(self)
    }
    #[doc = "Bit 1 - External AES Key Changed Interrupt"]
    #[inline(always)]
    #[must_use]
    pub fn key_change(&mut self) -> KEY_CHANGE_W<INTFL_SPEC, 1> {
        KEY_CHANGE_W::new(self)
    }
    #[doc = "Bit 2 - External AES Key Zero Interrupt"]
    #[inline(always)]
    #[must_use]
    pub fn key_zero(&mut self) -> KEY_ZERO_W<INTFL_SPEC, 2> {
        KEY_ZERO_W::new(self)
    }
    #[doc = "Bit 3 - Data Output FIFO Overrun Interrupt"]
    #[inline(always)]
    #[must_use]
    pub fn ov(&mut self) -> OV_W<INTFL_SPEC, 3> {
        OV_W::new(self)
    }
    #[doc = "Bit 4 - KEY_ONE"]
    #[inline(always)]
    #[must_use]
    pub fn key_one(&mut self) -> KEY_ONE_W<INTFL_SPEC, 4> {
        KEY_ONE_W::new(self)
    }
