...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pt0(&mut self) -> PT0_W<ENABLE_SPEC, 0> {
        PT0_W::new(self)
    }
    #[doc = "Bit 1 - Enable/Disable control for PT1"]
    #[inline(always)]
    #[must_use]
    pub fn pt1(&mut self) -> PT1_W<ENABLE_SPEC, 1> {
        PT1_W::new(self)
    }
    #[doc = "Bit 2 - Enable/Disable control for PT2"]
    #[inline(always)]
    #[must_use]
    pub fn pt2(&mut self) -> PT2_W<ENABLE_SPEC, 2> {
        PT2_W::new(self)
    }
    #[doc = "Bit 3 - Enable/Disable control for PT3"]
    #[inline(always)]
    #[must_use]
    pub fn pt3(&mut self) -> PT3_W<ENABLE_SPEC, 3> {
        PT3_W::new(self)
    }
