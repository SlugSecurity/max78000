...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pt0(&mut self) -> PT0_W<INTFL_SPEC, 0> {
        PT0_W::new(self)
    }
    #[doc = "Bit 1 - Pulse Train 1 Stopped Interrupt Flag"]
    #[inline(always)]
    #[must_use]
    pub fn pt1(&mut self) -> PT1_W<INTFL_SPEC, 1> {
        PT1_W::new(self)
    }
    #[doc = "Bit 2 - Pulse Train 2 Stopped Interrupt Flag"]
    #[inline(always)]
    #[must_use]
    pub fn pt2(&mut self) -> PT2_W<INTFL_SPEC, 2> {
        PT2_W::new(self)
    }
    #[doc = "Bit 3 - Pulse Train 3 Stopped Interrupt Flag"]
    #[inline(always)]
    #[must_use]
    pub fn pt3(&mut self) -> PT3_W<INTFL_SPEC, 3> {
        PT3_W::new(self)
    }
