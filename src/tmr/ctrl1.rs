...
pub type CLKSEL_A_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 2, O>;
...
pub type CLKRDY_A_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type EVENT_SEL_A_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 3, O>;
...
pub type NEGTRIG_A_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type IE_A_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type CAPEVENT_SEL_A_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 2, O>;
...
pub type SW_CAPEVENT_A_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type WE_A_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type OUTEN_A_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type OUTBEN_A_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type CLKSEL_B_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 2, O>;
...
pub type CLKRDY_B_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type EVENT_SEL_B_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 3, O>;
...
pub type NEGTRIG_B_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type IE_B_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type CAPEVENT_SEL_B_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 2, O>;
...
pub type SW_CAPEVENT_B_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type WE_B_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type CASCADE_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clksel_a(&mut self) -> CLKSEL_A_W<CTRL1_SPEC, 0> {
        CLKSEL_A_W::new(self)
    }
    #[doc = "Bit 2 - Timer A Enable Status"]
    #[inline(always)]
    #[must_use]
    pub fn clken_a(&mut self) -> CLKEN_A_W<CTRL1_SPEC, 2> {
        CLKEN_A_W::new(self)
    }
    #[doc = "Bit 3 - CLK_TMR Ready Flag for Timer A"]
    #[inline(always)]
    #[must_use]
    pub fn clkrdy_a(&mut self) -> CLKRDY_A_W<CTRL1_SPEC, 3> {
        CLKRDY_A_W::new(self)
    }
    #[doc = "Bits 4:6 - Event Select for Timer A"]
    #[inline(always)]
    #[must_use]
    pub fn event_sel_a(&mut self) -> EVENT_SEL_A_W<CTRL1_SPEC, 4> {
        EVENT_SEL_A_W::new(self)
    }
    #[doc = "Bit 7 - Negative Edge Trigger for Event for Timer A"]
    #[inline(always)]
    #[must_use]
    pub fn negtrig_a(&mut self) -> NEGTRIG_A_W<CTRL1_SPEC, 7> {
        NEGTRIG_A_W::new(self)
    }
    #[doc = "Bit 8 - Interrupt Enable for Timer A"]
    #[inline(always)]
    #[must_use]
    pub fn ie_a(&mut self) -> IE_A_W<CTRL1_SPEC, 8> {
        IE_A_W::new(self)
    }
    #[doc = "Bits 9:10 - Capture Event Select for Timer A"]
    #[inline(always)]
    #[must_use]
    pub fn capevent_sel_a(&mut self) -> CAPEVENT_SEL_A_W<CTRL1_SPEC, 9> {
        CAPEVENT_SEL_A_W::new(self)
    }
    #[doc = "Bit 11 - Software Capture Event for Timer A"]
    #[inline(always)]
    #[must_use]
    pub fn sw_capevent_a(&mut self) -> SW_CAPEVENT_A_W<CTRL1_SPEC, 11> {
        SW_CAPEVENT_A_W::new(self)
    }
    #[doc = "Bit 12 - Wake-Up Enable for Timer A"]
    #[inline(always)]
    #[must_use]
    pub fn we_a(&mut self) -> WE_A_W<CTRL1_SPEC, 12> {
        WE_A_W::new(self)
    }
    #[doc = "Bit 13 - OUT_OE_O Enable for Modes 0, 1,and 5 for Timer A"]
    #[inline(always)]
    #[must_use]
    pub fn outen_a(&mut self) -> OUTEN_A_W<CTRL1_SPEC, 13> {
        OUTEN_A_W::new(self)
    }
    #[doc = "Bit 14 - PWM_CKB_EN_O Enable for Modes other than Mode 3 for Timer A"]
    #[inline(always)]
    #[must_use]
    pub fn outben_a(&mut self) -> OUTBEN_A_W<CTRL1_SPEC, 14> {
        OUTBEN_A_W::new(self)
    }
    #[doc = "Bits 16:17 - Timer Clock Select for Timer B"]
    #[inline(always)]
    #[must_use]
    pub fn clksel_b(&mut self) -> CLKSEL_B_W<CTRL1_SPEC, 16> {
        CLKSEL_B_W::new(self)
    }
    #[doc = "Bit 18 - Timer B Enable Status"]
    #[inline(always)]
    #[must_use]
    pub fn clken_b(&mut self) -> CLKEN_B_W<CTRL1_SPEC, 18> {
        CLKEN_B_W::new(self)
    }
    #[doc = "Bit 19 - CLK_TMR Ready Flag for Timer B"]
    #[inline(always)]
    #[must_use]
    pub fn clkrdy_b(&mut self) -> CLKRDY_B_W<CTRL1_SPEC, 19> {
        CLKRDY_B_W::new(self)
    }
    #[doc = "Bits 20:22 - Event Select for Timer B"]
    #[inline(always)]
    #[must_use]
    pub fn event_sel_b(&mut self) -> EVENT_SEL_B_W<CTRL1_SPEC, 20> {
        EVENT_SEL_B_W::new(self)
    }
    #[doc = "Bit 23 - Negative Edge Trigger for Event for Timer B"]
    #[inline(always)]
    #[must_use]
    pub fn negtrig_b(&mut self) -> NEGTRIG_B_W<CTRL1_SPEC, 23> {
        NEGTRIG_B_W::new(self)
    }
    #[doc = "Bit 24 - Interrupt Enable for Timer B"]
    #[inline(always)]
    #[must_use]
    pub fn ie_b(&mut self) -> IE_B_W<CTRL1_SPEC, 24> {
        IE_B_W::new(self)
    }
    #[doc = "Bits 25:26 - Capture Event Select for Timer B"]
    #[inline(always)]
    #[must_use]
    pub fn capevent_sel_b(&mut self) -> CAPEVENT_SEL_B_W<CTRL1_SPEC, 25> {
        CAPEVENT_SEL_B_W::new(self)
    }
    #[doc = "Bit 27 - Software Capture Event for Timer B"]
    #[inline(always)]
    #[must_use]
    pub fn sw_capevent_b(&mut self) -> SW_CAPEVENT_B_W<CTRL1_SPEC, 27> {
        SW_CAPEVENT_B_W::new(self)
    }
    #[doc = "Bit 28 - Wake-Up Enable for Timer B"]
    #[inline(always)]
    #[must_use]
    pub fn we_b(&mut self) -> WE_B_W<CTRL1_SPEC, 28> {
        WE_B_W::new(self)
    }
    #[doc = "Bit 31 - Cascade two 16-bit timers into one 32-bit timer. Only available when C_TMR16=0 adn C_DUALTMR16=1."]
    #[inline(always)]
    #[must_use]
    pub fn cascade(&mut self) -> CASCADE_W<CTRL1_SPEC, 31> {
        CASCADE_W::new(self)
    }
