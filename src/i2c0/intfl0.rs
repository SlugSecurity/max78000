...
pub type DONE_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O, INT_FL0_DONE_A>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn done(&mut self) -> DONE_W<INTFL0_SPEC, 0> {
        DONE_W::new(self)
    }
    #[doc = "Bit 1 - Interactive Receive Interrupt."]
    #[inline(always)]
    #[must_use]
    pub fn irxm(&mut self) -> IRXM_W<INTFL0_SPEC, 1> {
        IRXM_W::new(self)
    }
    #[doc = "Bit 2 - Slave General Call Address Match Interrupt."]
    #[inline(always)]
    #[must_use]
    pub fn gc_addr_match(&mut self) -> GC_ADDR_MATCH_W<INTFL0_SPEC, 2> {
        GC_ADDR_MATCH_W::new(self)
    }
    #[doc = "Bit 3 - Slave Address Match Interrupt."]
    #[inline(always)]
    #[must_use]
    pub fn addr_match(&mut self) -> ADDR_MATCH_W<INTFL0_SPEC, 3> {
        ADDR_MATCH_W::new(self)
    }
    #[doc = "Bit 4 - Receive Threshold Interrupt. This bit is automaticcaly cleared when RX_FIFO is below the threshold level."]
    #[inline(always)]
    #[must_use]
    pub fn rx_thd(&mut self) -> RX_THD_W<INTFL0_SPEC, 4> {
        RX_THD_W::new(self)
    }
    #[doc = "Bit 5 - Transmit Threshold Interrupt. This bit is automaticcaly cleared when TX_FIFO is above the threshold level."]
    #[inline(always)]
    #[must_use]
    pub fn tx_thd(&mut self) -> TX_THD_W<INTFL0_SPEC, 5> {
        TX_THD_W::new(self)
    }
    #[doc = "Bit 6 - STOP Interrupt."]
    #[inline(always)]
    #[must_use]
    pub fn stop(&mut self) -> STOP_W<INTFL0_SPEC, 6> {
        STOP_W::new(self)
    }
    #[doc = "Bit 7 - Address Acknowledge Interrupt."]
    #[inline(always)]
    #[must_use]
    pub fn addr_ack(&mut self) -> ADDR_ACK_W<INTFL0_SPEC, 7> {
        ADDR_ACK_W::new(self)
    }
    #[doc = "Bit 8 - Arbritation error Interrupt."]
    #[inline(always)]
    #[must_use]
    pub fn arb_err(&mut self) -> ARB_ERR_W<INTFL0_SPEC, 8> {
        ARB_ERR_W::new(self)
    }
    #[doc = "Bit 9 - timeout Error Interrupt."]
    #[inline(always)]
    #[must_use]
    pub fn to_err(&mut self) -> TO_ERR_W<INTFL0_SPEC, 9> {
        TO_ERR_W::new(self)
    }
    #[doc = "Bit 10 - Address NACK Error Interrupt."]
    #[inline(always)]
    #[must_use]
    pub fn addr_nack_err(&mut self) -> ADDR_NACK_ERR_W<INTFL0_SPEC, 10> {
        ADDR_NACK_ERR_W::new(self)
    }
    #[doc = "Bit 11 - Data NACK Error Interrupt."]
    #[inline(always)]
    #[must_use]
    pub fn data_err(&mut self) -> DATA_ERR_W<INTFL0_SPEC, 11> {
        DATA_ERR_W::new(self)
    }
    #[doc = "Bit 12 - Do Not Respond Error Interrupt."]
    #[inline(always)]
    #[must_use]
    pub fn dnr_err(&mut self) -> DNR_ERR_W<INTFL0_SPEC, 12> {
        DNR_ERR_W::new(self)
    }
    #[doc = "Bit 13 - Start Error Interrupt."]
    #[inline(always)]
    #[must_use]
    pub fn start_err(&mut self) -> START_ERR_W<INTFL0_SPEC, 13> {
        START_ERR_W::new(self)
    }
    #[doc = "Bit 14 - Stop Error Interrupt."]
    #[inline(always)]
    #[must_use]
    pub fn stop_err(&mut self) -> STOP_ERR_W<INTFL0_SPEC, 14> {
        STOP_ERR_W::new(self)
    }
    #[doc = "Bit 15 - Transmit Lock Out Interrupt."]
    #[inline(always)]
    #[must_use]
    pub fn tx_lockout(&mut self) -> TX_LOCKOUT_W<INTFL0_SPEC, 15> {
    ...
    #[inline(always)]
    #[must_use]
    pub fn rd_addr_match(&mut self) -> RD_ADDR_MATCH_W<INTFL0_SPEC, 22> {
        RD_ADDR_MATCH_W::new(self)
    }
    #[doc = "Bit 23 - Slave Write Address Match Interrupt"]
    #[inline(always)]
    #[must_use]
    pub fn wr_addr_match(&mut self) -> WR_ADDR_MATCH_W<INTFL0_SPEC, 23> {
