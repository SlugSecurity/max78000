...
pub type EX_ADDR_EN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O, EX_ADDR_EN_A>;
impl<'a, REG, const O: u8> EX_ADDR_EN_W<'a, REG, O>
where
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn start(&mut self) -> START_W<MSTCTRL_SPEC, 0> {
        START_W::new(self)
    }
    #[doc = "Bit 1 - Setting this bit to 1 will generate a repeated START."]
    #[inline(always)]
    #[must_use]
    pub fn restart(&mut self) -> RESTART_W<MSTCTRL_SPEC, 1> {
        RESTART_W::new(self)
    }
    #[doc = "Bit 2 - Setting this bit to 1 will generate a STOP condition."]
    #[inline(always)]
    #[must_use]
    pub fn stop(&mut self) -> STOP_W<MSTCTRL_SPEC, 2> {
        STOP_W::new(self)
    }
    #[doc = "Bit 7 - Slave Extend Address Select."]
    #[inline(always)]
    #[must_use]
    pub fn ex_addr_en(&mut self) -> EX_ADDR_EN_W<MSTCTRL_SPEC, 7> {
